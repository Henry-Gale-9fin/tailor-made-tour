// Enhanced features.ts with team-aware selection logic
import { supabase } from "@/integrations/supabase/client";
import { selectFeaturesForExploration } from "./enhancedLogic";
...
// Matrix: feature_id (with hyphens) → firm_type_key → teams[]
export const featureRelevanceMatrix: Record<string, Record<string, string[]>> = {
...
/**
 * LEGACY: Simple firm-type based selection
 * Use getEnhancedFeaturesForUser for better results
 */
...
/**
 * ENHANCED: Team-aware feature selection with seniority consideration
 * Provides better, more targeted feature recommendations
 */
export const getEnhancedFeaturesForUser = (
  firmType: string,
  team: string | undefined,
  seniority: string,
  allFeatures: Feature[]
): Feature[] => {
  return selectFeaturesForExploration(
    allFeatures,
    {
      firmType,
      team,
      seniority,
      frequency: "Regular", // Default for initial selection
    },
